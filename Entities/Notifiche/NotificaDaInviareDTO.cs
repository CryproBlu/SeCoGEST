...
{
    public class NotificaDaInviareDTO
    {
        #region Properties Pubbliche

        public EntityId<Operatore> IdentifierOperatore { get; private set; }
        ...
        public NotificaDaInviareDTO(EntityId<Operatore> idOperatore, string nominativo, TipologiaNotificaEnum tipologiaNotifica, List<InformazioneNotiticaDaInviareDTO> elencoInformazioni = null)
        {
            InizializzaIstanza(idOperatore, nominativo, tipologiaNotifica, elencoInformazioni);
        }
        ...
        /// <param name="tipologiaNotifica"></param>
        /// <param name="elencoInformazioni"></param>
        private void InizializzaIstanza(EntityId<Operatore> idOperatore, string nominativo, TipologiaNotificaEnum tipologiaNotifica, List<InformazioneNotiticaDaInviareDTO> elencoInformazioni = null)
        {
            if (idOperatore == null) throw new ArgumentNullException("idOperatore", "Parametro nullo");

            IdentifierOperatore = idOperatore;
