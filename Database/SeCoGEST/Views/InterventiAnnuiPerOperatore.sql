CREATE VIEW SeCoGEST.InterventiAnnuiPerOperatore
AS
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'SeCoGEST', @level1type = N'VIEW', @level1name = N'InterventiAnnuiPerOperatore';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' Or = 1350
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'SeCoGEST', @level1type = N'VIEW', @level1name = N'InterventiAnnuiPerOperatore';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[26] 4[8] 2[34] 3) )"
      End
