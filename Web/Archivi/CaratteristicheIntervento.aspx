<%@ Page Title="Archivio Caratteristiche Intervento" Language="C#" MasterPageFile="~/UI/Main.Master" AutoEventWireup="true" CodeBehind="CaratteristicheIntervento.aspx.cs" Inherits="SeCoGEST.Web.Archivi.CaratteristicheIntervento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="title" runat="server">
    Archivio Caratteristiche Intervento
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="main" runat="server">
	...
	<telerik:RadGrid RenderMode="Lightweight" ID="rgArchiveItems" runat="server"
		...
		<MasterTableView CommandItemDisplay="TopAndBottom" NoMasterRecordsText="<div style='padding: 15px; background-color: #EFCF02; width: 100%'><strong>Nessuna Caratteristica Intervento da visualizzare.</strong></div>"
			DataKeyNames="Id">
			<Columns>
				<telerik:GridEditCommandColumn HeaderStyle-Width="60px"></telerik:GridEditCommandColumn>
				<telerik:GridBoundColumn UniqueName="Id" HeaderText="Num" DataField="Id" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Right"></telerik:GridBoundColumn>
			...
			<EditFormSettings EditFormType="Template" EditColumn-CancelText="Annulla" EditColumn-InsertText="Aggiungi" EditColumn-UpdateText="Salva" >
				<FormTemplate>
					...
					<div style="margin: 15px;">
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="rntbNumero" Width="100px" Text='<%# Bind("Id") %>' MinValue="0" NumberFormat-DecimalDigits="0" TabIndex="0"></telerik:RadNumericTextBox>
                        <telerik:RadTextBox runat="server" ID="rtbNome" MaxLength="100" Width="100%" Text='<%# Bind("Nome") %>' TabIndex="1"></telerik:RadTextBox>
