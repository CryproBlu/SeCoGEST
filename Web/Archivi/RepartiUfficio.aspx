<%@ Page Title="Archivio Reparti" Language="C#" MasterPageFile="~/UI/Main.Master" AutoEventWireup="true" CodeBehind="RepartiUfficio.aspx.cs" Inherits="SeCoGEST.Web.Archivi.RepartiUfficio" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="main" runat="server">
	...
	<telerik:RadGrid RenderMode="Lightweight" ID="rgArchiveItems" runat="server"
		...
		<MasterTableView CommandItemDisplay="TopAndBottom" NoMasterRecordsText="<div style='padding: 15px; background-color: #EFCF02; width: 100%'><strong>Nessun Reparto da visualizzare.</strong></div>"
			DataKeyNames="Id">
			<Columns>
				<telerik:GridEditCommandColumn HeaderStyle-Width="60px"></telerik:GridEditCommandColumn>
				<telerik:GridHyperLinkColumn UniqueName="Orari" HeaderStyle-Width="80px" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="/Archivi/OrariRepartiUfficio.aspx?rep={0}" Text="Orari..." DataTextFormatString="Orari..."></telerik:GridHyperLinkColumn>
				<telerik:GridBoundColumn UniqueName="Reparto" HeaderText="Reparto" DataField="Reparto"></telerik:GridBoundColumn>
			...
			<EditFormSettings EditFormType="Template" EditColumn-CancelText="Annulla" EditColumn-InsertText="Aggiungi" EditColumn-UpdateText="Salva" >
				<FormTemplate>
					...
					<div style="margin: 15px;">
                        ...
                        <telerik:RadTextBox runat="server" ID="rtbNome" MaxLength="100" Width="100%" Text='<%# Bind("Reparto") %>' TabIndex="0"></telerik:RadTextBox>
