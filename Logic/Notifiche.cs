...
{
    public class Notifiche : Base.LogicLayerBase
    {
        ...
        public Notifiche(bool createStandaloneContext)
        ...
        public Notifiche(Base.LogicLayerBase logicLayer)
            : base(logicLayer)
        {
            CreateDalAndLogic();
        }
        ...
        {
            dal = new Data.Notifiche(this.context);
        }
        ...
        public void Create(Entities.Notifica entityToCreate, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante la creazione dell'entity 'Notifica': parametro nullo!");
            }
        }
        ...
        /// <returns></returns>
        public Entities.Notifica Find(Entities.TipologiaNotificaEnum tipologiaNotifica)
        {
            return dal.Find((byte)tipologiaNotifica);
        }
        ...
        public void Delete(Entities.Notifica entityToDelete, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante l'eliminazione dell'entity 'Notifica': parametro nullo!");
            }
        }
        ...
        public void Delete(IEnumerable<Entities.Notifica> entitiesToDelete, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante l'eliminazione delle entities 'Notifica': parametro nullo!");
            }
        }
