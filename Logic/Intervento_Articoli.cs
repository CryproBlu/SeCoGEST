...
{
    public class Intervento_Articoli : Base.LogicLayerBase
    {
        ...
        public Intervento_Articoli(bool createStandaloneContext)
        ...
        public Intervento_Articoli(Base.LogicLayerBase logicLayer)
            : base(logicLayer)
        {
            CreateDalAndLogic();
        }
        ...
        {
            dal = new Data.Intervento_Articoli(this.context);
        }
        ...
        public void Create(Entities.Intervento_Articolo entityToCreate, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante la creazione dell'entity 'Intervento_Articolo': parametro nullo!");
            }
        }

        /// <summary>
        /// Restituisce tutte le entities in base allo stato del'Intervento_Articolo
        /// </summary>
        /// <returns></returns>
        public IQueryable<Entities.Intervento_Articolo> Read(Entities.Intervento intervento)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IQueryable<Entities.Intervento_Articolo> Read(EntityId<Entities.Intervento> idIntervento)
        {
            return dal.Read().Where(x => x.IDIntervento == idIntervento.Value).OrderBy(x => x.CodiceArticolo);
        }
        ...
        /// <returns></returns>
        public Entities.Intervento_Articolo Find(EntityId<Entities.Intervento_Articolo> idToFind)
        {
        ...
        /// <param name="submitChanges"></param>
        public void Delete(Entities.Intervento_Articolo entityToDelete, bool checkAllegati, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante l'eliminazione dell'entity 'Intervento_Articolo': parametro nullo!");
            }
        }
        ...
        /// <param name="checkAllegati"></param>
        /// <param name="submitChanges"></param>
        public void Delete(IEnumerable<Entities.Intervento_Articolo> entitiesToDelete, bool checkAllegati, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante l'eliminazione delle entities 'Intervento_Articolo': parametro nullo!");
            }
        }
