...
{
    public class Intervento_CaratteristicheTipologieIntervento : Base.LogicLayerBase
    {
        ...
        /// </summary>
        private Data.Intervento_CaratteristicheTipologieIntervento dalCaratteristicheTipologieIntervento;

        /// <summary>
        /// Crea l'istanza della classe utilizzando il DataContext globale condiviso
        /// </summary>
        public Intervento_CaratteristicheTipologieIntervento()
            : base(false)
        {
            CreateDalAndLogic();
        }
        ...
        public Intervento_CaratteristicheTipologieIntervento(bool createStandaloneContext)
        ...
        public Intervento_CaratteristicheTipologieIntervento(Base.LogicLayerBase logicLayer)
            : base(logicLayer)
        {
            CreateDalAndLogic();
        }
        ...
        {
            dalCaratteristicheTipologieIntervento = new Data.Intervento_CaratteristicheTipologieIntervento(this.context);
        }
        ...
        public void Create(Entities.Intervento_CaratteristicaTipologiaIntervento entityToCreate, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante la creazione dell'entity 'Intervento_CaratteristicaTipologiaIntervento': parametro nullo!");
            }
        }
        ...
        /// <returns></returns>
        public IQueryable<Entities.Intervento_CaratteristicaTipologiaIntervento> Read(Guid idIntervento)
        {
            return Read().Where(x => x.IdIntervento == idIntervento);
        }
        ...
        /// <returns></returns>
        public Entities.Intervento_CaratteristicaTipologiaIntervento Find(Guid IdConfigurazione, int IdCaratteristica)
        {
        ...
        /// <param name="submitChanges"></param>
        public void Delete(Entities.Intervento_CaratteristicaTipologiaIntervento entityToDelete, bool checkAllegati, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante l'eliminazione dell'entity 'Intervento_CaratteristicaTipologiaIntervento': parametro nullo!");
            }
        }
        ...
        /// <param name="checkAllegati"></param>
        /// <param name="submitChanges"></param>
        public void Delete(IEnumerable<Entities.Intervento_CaratteristicaTipologiaIntervento> entitiesToDelete, bool checkAllegati, bool submitChanges)
        {
            ...
            {
                throw new ArgumentNullException("Errore durante l'eliminazione delle entities 'Intervento_CaratteristicaTipologiaIntervento': parametro nullo!");
            }
        }
